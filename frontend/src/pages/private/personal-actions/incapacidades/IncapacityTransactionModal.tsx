...
function inferInstitutionByType(
  tipo: DisabilityType,
): DisabilityInstitutionType {
...
function getDefaultTypeByInstitution(
  institucion: DisabilityInstitutionType,
): DisabilityType {
...
export function DisabilityTransactionModal({
  ...
  const isLineComplete = (line: DisabilityTransactionLine): boolean =>
    ...
    !!line.tipoIncapacidad &&
    !!line.tipoInstitucion;
  const {
    lines,
    setLines,
    activeLineKeys,
                  ...
                  <div className={sharedStyles.employeeAccordionContent}>
                    ...
                    <div className={sharedStyles.employeeAccordionGrid}>
                      ...
                      <div className={sharedStyles.employeeAccordionItem}>
                        <DollarCircleOutlined className={sharedStyles.employeeAccordionItemIcon} />
                        <div>
                          <div className={sharedStyles.employeeAccordionItemLabel}>Salario {selectedPayPeriod?.nombre ?? 'Periodo'}</div>
                          <div className={sharedStyles.employeeAccordionItemValue}>
                        ...
                        <Col xs={24} md={12} lg={8}>
                          ...
                          <Tooltip title={!line.movimientoId ? 'Seleccione primero el movimiento' : undefined}>
                            <Select
                              style={{ width: '100%' }}
                              disabled={readOnly || !line.movimientoId}
                              placeholder={!line.movimientoId ? 'Seleccione movimiento primero' : 'Seleccione institución'}
