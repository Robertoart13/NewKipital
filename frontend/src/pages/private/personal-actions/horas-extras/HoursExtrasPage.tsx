...
export function HoursExtrasPage() {
  ...
  const loadOvertimeAuditTrail = useCallback(
    async (id: number) => {
  ...
  return (
    <div className={styles.pageWrapper}>
      ...
      <HoursExtraTransactionModal
        ...
        onLoadAuditTrail={mode === 'edit' && editingRow ? loadEditingOvertimeAuditTrail : undefined}
        ...
        onSubmit={async (draft) => {
          ...
          try {
            ...
            message.error({
              content: error instanceof Error ? error.message : 'No se pudo guardar la hora extra.',
              key: loadingKey,
              duration: 5,
            });
          }
