...
export function RetentionsPage() {
  ...
  const loadRetentionAuditTrail = useCallback(
    async (id: number) => {
  ...
  const loadCatalogs = useCallback(async () => {
    ...
    try {
      const [employeesResp, movementsResp, payPeriodsResp] = await Promise.all([
        ...
        fetchAbsenceMovementsCatalog(targetCompanyId, 5),
      ...
      <RetentionTransactionModal
        ...
        onSubmit={async (draft) => {
          ...
          try {
            ...
            message.error({
              content: error instanceof Error ? error.message : 'No se pudo guardar la retencion.',
              key: loadingKey,
              duration: 5,
            });
          }
