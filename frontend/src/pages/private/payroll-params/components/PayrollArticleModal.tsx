...
import { Button, Flex, Form, Input, Modal, Row, Col, Select, Spin, Switch, Table, Tabs, Tag } from 'antd';
...
export function PayrollArticleModal(props: PayrollArticleModalProps) {
  ...
  const singleCompanyLabel = singleCompany ? singleCompany.nombre?.trim() || `Empresa #${singleCompany.id}` : '';
                ...
                <>
                  ...
                  <Form.Item label="Tipo articulo actual">
                    <Flex align="center" gap={8}>
                      <Input
                        value={
                          tipoArticuloMap.get(editing.idTipoArticuloNomina) ?? `Tipo #${editing.idTipoArticuloNomina}`
                        }
                        disabled
                      />
                      <Tag className={styles.tagInactivo}>Inactivo</Tag>
                ...
                <>
                  ...
                  <Form.Item label="Tipo accion actual">
                    <Flex align="center" gap={8}>
                      <Input
                        value={
                          tipoAccionMap.get(editing.idTipoAccionPersonal) ?? `Accion #${editing.idTipoAccionPersonal}`
                        }
                        disabled
                      />
                      <Tag className={styles.tagInactivo}>Inactivo</Tag>
                  ...
                  <Form.Item label={`${primaryLabel} actual`}>
                    <Flex align="center" gap={8}>
                      <Input
                        ...
                        disabled
                      />
                      <Tag className={styles.tagInactivo}>{currentPrimaryAccount ? 'Inactivo' : 'No disponible'}</Tag>
                    </Flex>
                  </Form.Item>
                  <Form.Item
                    ...
                    <Form.Item label="Cuenta pasivo actual">
                      <Flex align="center" gap={8}>
                        <Input
                          ...
                          disabled
                        />
                        <Tag className={styles.tagInactivo}>{currentPasivoAccount ? 'Inactivo' : 'No disponible'}</Tag>
                      </Flex>
                    </Form.Item>
