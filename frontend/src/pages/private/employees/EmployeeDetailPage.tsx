      ...
      >
        {editing ? (
          ...
          <Descriptions column={1} bordered>
            <Descriptions.Item label="C?digo">{employee.codigo ?? '?'}</Descriptions.Item>
            <Descriptions.Item label="C?dula">{employee.cedula ?? '?'}</Descriptions.Item>
            <Descriptions.Item label="Apellidos">
              {[employee.apellido1, employee.apellido2].filter(Boolean).join(' ') || '?'}
            </Descriptions.Item>
            ...
            <Descriptions.Item label="Supervisor">
              {employee.idSupervisor
                ? buildEmployeeDisplayName(supervisorsRaw.find((s) => s.id === employee.idSupervisor) ?? {})
                : '?'}
            </Descriptions.Item>
            ...
            <Descriptions.Item label="Acceso Digital">{employee.idUsuario ? 'S?' : 'No'}</Descriptions.Item>
          </Descriptions>
        )}
      </Card>
    </div>
