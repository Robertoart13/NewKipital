...
function getInitials(apellido: string, nombre: string): string {
...
export function UsersManagementPage() {
  ...
  const filteredUsers = useMemo(() => {
    ...
    return users.filter(
      ...
      (u) => `${u.apellido} ${u.nombre}`.toLowerCase().includes(t) || (u.email ?? '').toLowerCase().includes(t),
  ...
  const columns: ColumnsType<SystemUser> = useSortableColumns([
      ...
      render: (_, user) => (
        ...
        <div className={styles.userCell}>
          ...
          <Avatar className={styles.userCellAvatar} icon={<UserOutlined />}>
            ...
            {getInitials(user.apellido, user.nombre)}

          </Avatar>

          <div>

            <div className={styles.userCellName}>{`${user.apellido} ${user.nombre}`}</div>
          ...
          <Flex align="center" justify="space-between" wrap="wrap" gap={16}>
            ...
            <Flex align="center" gap={16}>
              ...
              <div>
                ...
                <h2 className={styles.gestionTitle}>Gestión de Usuarios</h2>
          ...
          <>
            ...
            <div className={styles.userCard}>
              ...
              <Avatar className={styles.userCardAvatar} size={56}>
                ...
                {getInitials(selectedUser.apellido, selectedUser.nombre)}

              </Avatar>

              <div className={styles.userCardInfo}>

                <p className={styles.userCardName}>{`${selectedUser.apellido} ${selectedUser.nombre}`}</p>
