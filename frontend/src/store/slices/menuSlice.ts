    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { id: 'cuentas-contables', label: 'Cuentas Contables', path: '/configuration/cuentas-contables' },
          { id: 'departamentos', label: 'Departamentos', path: '/configuration/departamentos' },
          { id: 'puestos', label: 'Puestos', path: '/configuration/puestos' },
        ],
      },
    ],
  },
