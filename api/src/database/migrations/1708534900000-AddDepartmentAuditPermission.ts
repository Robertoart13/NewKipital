...
export class AddDepartmentAuditPermission1708534900000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      ...
      VALUES (
        'config:departamentos:audit',
        'Ver bitacora de departamentos',
        'Permite ver la bitacora de cambios de departamentos',
        'config',
        1,
        '${now}'
      )
    ...
    await queryRunner.query(
      ...
      INNER JOIN sys_permisos p
        ON p.codigo_permiso = 'config:departamentos:audit'
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      ...
      WHERE p.codigo_permiso = 'config:departamentos:audit'
      `,
    );
    ...
    await queryRunner.query(
      ...
      WHERE codigo_permiso = 'config:departamentos:audit'
      `,
    );
  }
}
