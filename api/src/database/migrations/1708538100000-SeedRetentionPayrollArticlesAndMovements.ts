...
export class SeedRetentionPayrollArticlesAndMovements1708538100000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      SELECT
        e.id_empresa,
        'Articulo de nomina Retencion',
        'Articulo operativo para acciones de personal de retenciones.',
        5,
        2,
      ...
      WHERE NOT EXISTS (
        ...
        WHERE a.id_empresa = e.id_empresa
          AND a.id_tipo_accion_personal = 5
          AND LOWER(a.nombre_articulo_nomina) = LOWER('Articulo de nomina Retencion')
      )
    `);
    ...
    await queryRunner.query(`
      ...
      SELECT
        ...
        NULL,
        NULL,
        'Movimiento de retencion por monto fijo.',
        1,
        '10000',
        '0',
        ...
        0
      FROM nom_articulos_nomina a
      WHERE a.id_tipo_accion_personal = 5
        AND a.es_inactivo = 0
        AND NOT EXISTS (
          SELECT 1
          ...
          WHERE m.id_empresa_movimiento_nomina = a.id_empresa
            ...
            AND LOWER(m.nombre_movimiento_nomina) = LOWER('Retencion Fija')
        )
    `);
    ...
    await queryRunner.query(`
      ...
      SELECT
        ...
        NULL,
        NULL,
        'Movimiento de retencion por porcentaje sobre salario base del periodo.',
        0,
        '0',
        '10',
      ...
      WHERE a.id_tipo_accion_personal = 5
        ...
        AND NOT EXISTS (
          ...
          WHERE m.id_empresa_movimiento_nomina = a.id_empresa
            AND m.id_tipo_accion_personal_movimiento_nomina = 5
            AND LOWER(m.nombre_movimiento_nomina) = LOWER('Retencion Porcentaje')
        )
    `);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      WHERE id_tipo_accion_personal_movimiento_nomina = 5
        AND LOWER(nombre_movimiento_nomina) IN (
          LOWER('Retencion Fija'),
          LOWER('Retencion Porcentaje')
        )
    `);

    await queryRunner.query(`
      DELETE FROM nom_articulos_nomina
      WHERE id_tipo_accion_personal = 5
        AND LOWER(nombre_articulo_nomina) = LOWER('Articulo de nomina Retencion')
    `);
  }
}
