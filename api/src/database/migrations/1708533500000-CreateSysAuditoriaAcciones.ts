    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'id_entidad_auditoria', type: 'varchar', length: '64', isNullable: true },
          { name: 'id_usuario_actor_auditoria', type: 'int', isNullable: true },
          { name: 'id_empresa_contexto_auditoria', type: 'int', isNullable: true },
          ...
          { name: 'ip_auditoria', type: 'varchar', length: '64', isNullable: true },
          { name: 'user_agent_auditoria', type: 'varchar', length: '255', isNullable: true },
          { name: 'fecha_creacion_auditoria', type: 'datetime', default: 'CURRENT_TIMESTAMP' },
        ],
      }),
      true,
    );
