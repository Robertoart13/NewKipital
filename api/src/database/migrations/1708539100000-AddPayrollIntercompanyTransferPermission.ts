...
export class AddPayrollIntercompanyTransferPermission1708539100000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      INSERT INTO sys_permisos (
        ...
        'Permite trasladar empleados entre empresas para procesos de planilla',
        'payroll',
        1,
        '${now}'
      )
    ...
    await queryRunner.query(`
      ...
      FROM sys_roles r
      INNER JOIN sys_permisos p ON p.codigo_permiso = 'payroll:intercompany-transfer'
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      WHERE p.codigo_permiso = 'payroll:intercompany-transfer'
    `);

    await queryRunner.query(`
      DELETE FROM sys_permisos
      WHERE codigo_permiso = 'payroll:intercompany-transfer'
    `);
  }
}
