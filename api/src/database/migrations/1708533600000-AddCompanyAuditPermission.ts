...
export class AddCompanyAuditPermission1708533600000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      ...
      VALUES (
        ...
        'Ver bitacora de empresas',
        'Permite consultar el historial de cambios de una empresa en Configuracion',
        'config',
        1,
        ?
      )
    ...
    await queryRunner.query(
      ...
      INNER JOIN sys_permisos p
        ON p.codigo_permiso = 'config:companies:audit'
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      ...
      WHERE p.codigo_permiso = 'config:companies:audit'
      `,
    );
    ...
    await queryRunner.query(
      ...
      WHERE codigo_permiso = 'config:companies:audit'
      `,
    );
  }
}
