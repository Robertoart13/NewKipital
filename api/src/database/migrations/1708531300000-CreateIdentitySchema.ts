...
export class CreateIdentitySchema1708531300000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'email_usuario', type: 'varchar', length: '150', isNullable: false, isUnique: true },
          { name: 'password_hash_usuario', type: 'varchar', length: '255', isNullable: false },
          { name: 'nombre_usuario', type: 'varchar', length: '100', isNullable: false },
          { name: 'apellido_usuario', type: 'varchar', length: '100', isNullable: false },
          { name: 'telefono_usuario', type: 'varchar', length: '30', isNullable: true },
          { name: 'avatar_url_usuario', type: 'varchar', length: '500', isNullable: true },
          { name: 'estado_usuario', type: 'tinyint', width: 1, default: 1 },
          { name: 'ultimo_login_usuario', type: 'datetime', isNullable: true },
          { name: 'fecha_creacion_usuario', type: 'datetime', default: 'CURRENT_TIMESTAMP' },
          {
          ...
          { name: 'fecha_inactivacion_usuario', type: 'datetime', isNullable: true },
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'codigo_app', type: 'varchar', length: '20', isNullable: false, isUnique: true },
          { name: 'nombre_app', type: 'varchar', length: '100', isNullable: false },
          { name: 'descripcion_app', type: 'varchar', length: '300', isNullable: true },
          { name: 'url_app', type: 'varchar', length: '300', isNullable: true },
          { name: 'icono_app', type: 'varchar', length: '100', isNullable: true },
          { name: 'estado_app', type: 'tinyint', width: 1, default: 1 },
          { name: 'fecha_creacion_app', type: 'datetime', default: 'CURRENT_TIMESTAMP' },
          {
    ...
    await queryRunner.createIndex('sys_apps', new TableIndex({
      name: 'IDX_app_codigo',
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'fecha_asignacion_usuario_app', type: 'datetime', default: 'CURRENT_TIMESTAMP' },
        ],
      }),
      true,
    );

    await queryRunner.createIndex('sys_usuario_app', new TableIndex({
      name: 'UQ_usuario_app',
      columnNames: ['id_usuario', 'id_app'],
      isUnique: true,
    }));

    await queryRunner.createForeignKey('sys_usuario_app', new TableForeignKey({
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'estado_usuario_empresa', type: 'tinyint', width: 1, default: 1 },
          { name: 'fecha_asignacion_usuario_empresa', type: 'datetime', default: 'CURRENT_TIMESTAMP' },
        ],
      }),
      true,
    );

    await queryRunner.createIndex('sys_usuario_empresa', new TableIndex({
      name: 'UQ_usuario_empresa',
      columnNames: ['id_usuario', 'id_empresa'],
      isUnique: true,
    }));

    await queryRunner.createForeignKey('sys_usuario_empresa', new TableForeignKey({
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'codigo_rol', type: 'varchar', length: '50', isNullable: false, isUnique: true },
          { name: 'nombre_rol', type: 'varchar', length: '100', isNullable: false },
          { name: 'descripcion_rol', type: 'varchar', length: '300', isNullable: true },
          { name: 'estado_rol', type: 'tinyint', width: 1, default: 1 },
          { name: 'fecha_creacion_rol', type: 'datetime', default: 'CURRENT_TIMESTAMP' },
          {
    ...
    await queryRunner.createIndex('sys_roles', new TableIndex({
      name: 'IDX_rol_codigo',
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'codigo_permiso', type: 'varchar', length: '100', isNullable: false, isUnique: true },
          { name: 'nombre_permiso', type: 'varchar', length: '150', isNullable: false },
          { name: 'descripcion_permiso', type: 'varchar', length: '300', isNullable: true },
          { name: 'modulo_permiso', type: 'varchar', length: '50', isNullable: false },
          { name: 'estado_permiso', type: 'tinyint', width: 1, default: 1 },
          { name: 'fecha_creacion_permiso', type: 'datetime', default: 'CURRENT_TIMESTAMP' },
        ],
      }),
      true,
    );

    await queryRunner.createIndex('sys_permisos', new TableIndex({
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'fecha_asignacion_rol_permiso', type: 'datetime', default: 'CURRENT_TIMESTAMP' },
        ],
      }),
      true,
    );

    await queryRunner.createIndex('sys_rol_permiso', new TableIndex({
      name: 'UQ_rol_permiso',
      columnNames: ['id_rol', 'id_permiso'],
      isUnique: true,
    }));

    await queryRunner.createForeignKey('sys_rol_permiso', new TableForeignKey({
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'fecha_asignacion_usuario_rol', type: 'datetime', default: 'CURRENT_TIMESTAMP' },
          {
          ...
          { name: 'modificado_por_usuario_rol', type: 'int', isNullable: false },
        ],
      }),
      true,
    );

    await queryRunner.createIndex('sys_usuario_rol', new TableIndex({
    ...
    await queryRunner.createForeignKey('sys_usuario_rol', new TableForeignKey({
