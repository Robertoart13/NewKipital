  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    if (!hasInputSnapshot) {
      ...
      await queryRunner.createIndex(
        'nomina_inputs_snapshot',
        new TableIndex({
          name: 'IDX_input_source',
          columnNames: ['source_type_input', 'source_id_input'],
        }),
      );
    ...
    if (!hasResults) {
      ...
      await queryRunner.createIndex(
        'nomina_resultados',
        new TableIndex({
          name: 'UQ_resultado_nomina_empleado',
          columnNames: ['id_nomina', 'id_empleado'],
          isUnique: true,
        }),
      );
