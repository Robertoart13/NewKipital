    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          {
            name: 'fecha_creacion_notificacion',
            type: 'datetime',
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          {
            name: 'estado_notificacion_usuario',
            type: 'varchar',
            length: '20',
            isNullable: false,
            default: "'UNREAD'",
          ...
          {
            name: 'fecha_entregada_notificacion_usuario',
            type: 'datetime',
            default: 'CURRENT_TIMESTAMP',
          },
          {
            name: 'fecha_leida_notificacion_usuario',
            type: 'datetime',
            isNullable: true,
          },
          {
            name: 'fecha_eliminada_notificacion_usuario',
            type: 'datetime',
            isNullable: true,
          },
        ],
