...
export class AddPositionAuditPermission1708535600000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      ...
      VALUES (
        'config:puestos:audit',
        'Ver bitacora de puestos',
        'Permite ver la bitacora de cambios de puestos',
        'config',
        1,
        '${now}'
      )
    ...
    await queryRunner.query(
      ...
      INNER JOIN sys_permisos p
        ON p.codigo_permiso = 'config:puestos:audit'
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      ...
      WHERE p.codigo_permiso = 'config:puestos:audit'
      `,
    );
    ...
    await queryRunner.query(
      ...
      WHERE codigo_permiso = 'config:puestos:audit'
      `,
    );
  }
}
