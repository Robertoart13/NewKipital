...
export class RedefineEmpleadoEnterprise1708531700000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          {
            name: 'fecha_creacion_departamento',
            type: 'datetime',
            default: 'CURRENT_TIMESTAMP',
          },
          {
            name: 'fecha_modificacion_departamento',
            type: 'datetime',
            default: 'CURRENT_TIMESTAMP',
          ...
          {
            name: 'modificado_por_departamento',
            type: 'int',
            isNullable: true,
          },
        ],
    ...
    await queryRunner.createIndex(
      'org_departamentos',
      new TableIndex({
        name: 'IDX_departamento_externo',
        columnNames: ['id_externo_departamento'],
      }),
    );
    await queryRunner.createIndex(
      'org_departamentos',
      new TableIndex({
        name: 'IDX_departamento_estado',
        columnNames: ['estado_departamento'],
      }),
    );
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          {
            name: 'fecha_creacion_puesto',
            type: 'datetime',
            default: 'CURRENT_TIMESTAMP',
          },
          {
            name: 'fecha_modificacion_puesto',
            type: 'datetime',
            default: 'CURRENT_TIMESTAMP',
            onUpdate: 'CURRENT_TIMESTAMP',
          },
    ...
    await queryRunner.createIndex(
      'org_puestos',
      new TableIndex({
        name: 'IDX_puesto_estado',
        columnNames: ['estado_puesto'],
      }),
    );
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          {
            name: 'fecha_modificacion_periodo_pago',
            type: 'datetime',
            default: 'CURRENT_TIMESTAMP',
            onUpdate: 'CURRENT_TIMESTAMP',
          },
      ...
      new Table({
        ...
        columns: [
          ...
          { name: 'motivo_salida_empleado', type: 'text', isNullable: true },
          {
            ...
            type: 'enum',
            enum: ['Indefinido', 'Plazo Fijo', 'Por Servicios Profesionales'],
            isNullable: true,
          },
          {
            name: 'jornada_empleado',
            type: 'enum',
            enum: ['Tiempo Completo', 'Medio Tiempo', 'Por Horas'],
            isNullable: true,
          },
    ...
    await queryRunner.createIndex(
      'sys_empleados',
      new TableIndex({
        name: 'IDX_empleado_cedula',
        columnNames: ['cedula_empleado'],
        isUnique: true,
      }),
    );
    await queryRunner.createIndex(
    ...
    await queryRunner.createIndex(
      'sys_empleados',
      new TableIndex({
        name: 'IDX_empleado_departamento',
    ...
    await queryRunner.createIndex(
      'sys_empleados',
      new TableIndex({
        name: 'IDX_empleado_puesto',
        columnNames: ['id_puesto'],
      }),
    );
    await queryRunner.createIndex(
      'sys_empleados',
      new TableIndex({
        name: 'IDX_empleado_supervisor',
        columnNames: ['id_supervisor_empleado'],
      }),
    );
    await queryRunner.createIndex(
      'sys_empleados',
      new TableIndex({
        name: 'IDX_empleado_periodo_pago',
    ...
    await queryRunner.createForeignKey(
      ...
      new TableForeignKey({
        ...
        columnNames: ['id_departamento'],
        referencedTableName: 'org_departamentos',
    ...
    await queryRunner.createForeignKey(
      ...
      new TableForeignKey({
        ...
        columnNames: ['id_puesto'],
        referencedTableName: 'org_puestos',
        referencedColumnNames: ['id_puesto'],
        onDelete: 'RESTRICT',
        onUpdate: 'CASCADE',
      }),
    );
