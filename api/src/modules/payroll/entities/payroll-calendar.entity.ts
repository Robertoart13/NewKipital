...
export class PayrollCalendar {
  ...
  @Column({
    name: 'nombre_planilla_calendario_nomina',
    type: 'varchar',
    length: 150,
    nullable: true,
  })
  ...
  @Column({
    name: 'fecha_corte_calendario_nomina',
    type: 'date',
    nullable: true,
  })
  ...
  @Column({
    name: 'fecha_pago_programada_calendario_nomina',
    type: 'date',
    nullable: true,
  })
  ...
  @Column({
    name: 'slot_key_calendario_nomina',
    type: 'varchar',
    length: 255,
    nullable: true,
  })
  ...
  @Column({
    name: 'is_active_slot_calendario_nomina',
    type: 'tinyint',
    width: 1,
    default: 1,
  })
