# Accion Bonificaciones

## Flujo operativo
```mermaid
flowchart TD
  A[Crear bonificacion] --> B[Capturar monto o porcentaje]
  B --> C[Validar tipo de calculo]
  C --> D[Guardar]
  D --> E[Aprobacion RRHH]
  E --> F[Aplicacion en planilla]
```
...
### Fuente: docs/46-AccionesPersonal-Bonificaciones-Implementacion-Operativa.md
