...
```mermaid
flowchart TD
  A[Crear ausencia] --> B[Seleccion empresa y empleado]
  B --> C[Definir tipo y fechas]
  C --> D[Calcular monto por regla]
  D --> E[Guardar lineas]
  E --> F[Enviar aprobacion]
  F --> G[Consumo en planilla]
```
...
### Fuente: docs/43-AccionesPersonal-Ausencias-Implementacion-Operativa.md
...
### Fuente: docs/44-ContratosAPI-Ausencias-20260228.md
...
### Fuente: docs/45-Handoff-AccionesPersonal-Ausencias.md
