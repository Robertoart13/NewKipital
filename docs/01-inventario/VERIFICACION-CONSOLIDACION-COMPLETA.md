...
3. **Índice maestro (00-INDICE-CONSOLIDACION):** Añadir enlaces a los documentos maestros por dominio (03-reglas, 04-arquitectura, … 12-backlog, 99-historico) para navegación directa desde el índice.
